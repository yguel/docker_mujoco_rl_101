...
"""
Path("/home/student/workspace/examples/collisions_demo.xml").write_text(xml)
m = mujoco.MjModel.from_xml_path("/home/student/workspace/examples/collisions_demo.xml")
d = mujoco.MjData(m)
